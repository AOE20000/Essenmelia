...
- **隐私保护 (Security Shield)**：内置安全盾牌。非信任扩展在未获得授权时，所有敏感操作（如读取数据）都会被自动拦截或返回伪造数据，确保用户隐私安全。
...
- [创建仓库指南](assets/docs/create_repository_guide.md) - 了解如何托管并分发你的扩展。
- [代码示例](https://github.com/AOE20000/Export-from-Bangumi-to-Essenmelia) - 浏览官方提供的扩展示例。
- [项目地址](https://github.com/AOE20000/Essenmelia) - 查看项目的 GitHub 仓库。
---
*最后更新：2026-02-22*
