...
abstract class AppLocalizations {
  ...
  /// Button label to check for app updates
  ///
  /// In en, this message translates to:
  /// **'Check for Updates'**
  String get checkForUpdates;

  /// Snackbar message during update check
  ///
  /// In en, this message translates to:
  /// **'Checking for updates...'**
  String get checkingForUpdates;

  /// Snackbar message when app is on latest version
  ///
  /// In en, this message translates to:
  /// **'Already up to date'**
  ...
  /// Application description shown in about screen
  ///
  /// In en, this message translates to:
  /// **'Your All-in-One Progress Tracker & Extension Hub'**
  String get appDescription;

  /// Notification title when a new version is found
  ///
  /// In en, this message translates to:
  /// **'New version available: {version}'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Click to download update from GitHub'**
  String get clickToDownload;

  /// Notification channel name for updates
  ///
  /// In en, this message translates to:
  /// **'App Updates'**
  String get updateChannelName;

  /// Notification channel description for updates
  ///
  /// In en, this message translates to:
  /// **'Reminders for app version updates'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Essenmelia is a highly customizable, privacy-secure, and cross-platform personal record and tracking tool.'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Private Data, No Interference'**
  String get welcomeSubtitle2;

  /// Content for privacy slide
  ///
  /// In en, this message translates to:
  /// **'Born as a revolt against \'pseudo-offline\' software—your data stays local, no forced internet, no bundled services.'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Where there\'s progress, there\'s a record'**
  String get welcomeSubtitle3;

  /// Content for customization slide
  ///
  /// In en, this message translates to:
  /// **'Whether it\'s anime, movies, novels, or games—everything is designed for the display that fits you best.'**
  String get welcomeContent3;

  /// Title for extensions slide
  ///
  /// In en, this message translates to:
  /// **'Powerful Extension Ecosystem'**
  String get powerfulExtensions;

  /// Subtitle for extensions slide
  ///
  /// In en, this message translates to:
  /// **'Breaking boundaries'**
  String get welcomeSubtitle4;

  /// Content for extensions slide
  ///
  /// In en, this message translates to:
  /// **'With a powerful plugin architecture, support auto-fetching info, in-app playback, and importing third-party records.'**
