...
export const GripVerticalIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || 'w-6 h-6'}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75l.383.212A2.25 2.25 0 0012 15.06l.383-.212A2.25 2.25 0 0015 12.75V8.25A2.25 2.25 0 0012.75 6l-.383.212A2.25 2.25 0 0012 8.31l-.383-.212A2.25 2.25 0 009 8.25v4.5zM9 12.75v4.5a2.25 2.25 0 001.25 2.048l.383.212a2.25 2.25 0 002.734 0l.383-.212A2.25 2.25 0 0015 17.25v-4.5m-6 0v4.5m0-4.5a2.25 2.25 0 00-2.25-2.25H5.25A2.25 2.25 0 003 8.25v4.5A2.25 2.25 0 005.25 15h1.5a2.25 2.25 0 002.25-2.25m-9 0v4.5a2.25 2.25 0 002.25 2.25h1.5a2.25 2.25 0 002.25-2.25v-4.5m0 0a2.25 2.25 0 00-2.25-2.25H5.25A2.25 2.25 0 003 8.25m15 0v4.5a2.25 2.25 0 002.25 2.25h1.5a2.25 2.25 0 002.25-2.25v-4.5a2.25 2.25 0 00-2.25-2.25h-1.5a2.25 2.25 0 00-2.25 2.25m3 0m-3 0v4.5m0-4.5a2.25 2.25 0 00-2.25-2.25h-1.5a2.25 2.25 0 00-2.25 2.25" />
    </svg>
);
